...
const axEyeL = new THREE.Mesh(new THREE.BoxGeometry(0.16, 0.2, 0.08), new THREE.MeshBasicMaterial({ color: 0x111111 }));
const axEyeR = axEyeL.clone();
const axEyeShineL = new THREE.Mesh(new THREE.BoxGeometry(0.05, 0.05, 0.04), new THREE.MeshBasicMaterial({ color: 0xffffff }));
...
axEyeL.position.set(1.8, 0.24, 0.24);
axEyeR.position.set(1.8, 0.24, -0.24);
axEyeShineL.position.set(1.86, 0.29, 0.27);
axEyeShineR.position.set(1.86, 0.29, -0.21);
